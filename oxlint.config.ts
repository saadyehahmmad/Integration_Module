...
export default defineConfig({
  ...
  rules: {
    ...
    'sort-keys': 'off',
    'func-style': 'off',
    'react/function-component-definition': 'off', // Next.js pages use `function` declarations
    'typescript/no-deprecated': 'off', // next-intl still uses setRequestLocale until root-params migration
